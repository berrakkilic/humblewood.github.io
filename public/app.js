...
${choices}`,
  ...
  function setSharedHandoutReopenVisible(visible, broadcast = null) {
  ...
  const REACTION_PRESETS = [
    ...
    {
      id: "core-ready-action",
      group: "Core rules",
      name: "Readied Action",
      requirement: "Ready action taken on your turn",
      resource: "One reaction; readied spells also require concentration",
      source: "Core rules",
    ...
    },
    {
      ...
      group: "Class & subclass features",
      name: "Retaliation",
      requirement: "Path of the Berserker Barbarian 14",
      resource: "One reaction",
    ...
    },
    {
      ...
      group: "Class & subclass features",
      name: "Cutting Words",
      requirement: "College of Lore Bard 3",
      resource: "One reaction and one Bardic Inspiration die",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Class & subclass features",
      name: "Combat Inspiration (AC)",
      requirement: "A Bardic Inspiration die from a College of Valor Bard",
      resource: "One reaction and the inspiration die",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Class & subclass features",
      name: "Warding Flare",
      requirement: "Light Domain Cleric 1",
      resource: "One reaction; uses equal to Wisdom modifier per long rest",
      source: "Player's Handbook",
    ...
    {
      id: "cleric-dampen-elements",
      group: "Class & subclass features",
      name: "Dampen Elements",
      requirement: "Nature Domain Cleric 6",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    {
      id: "cleric-wrath-of-the-storm",
      group: "Class & subclass features",
      name: "Wrath of the Storm",
      requirement: "Tempest Domain Cleric 1",
      resource: "One reaction; uses equal to Wisdom modifier per long rest",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      requirement: "War Domain Cleric 6",
      resource: "One reaction and Channel Divinity",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      requirement: "Protection style and a shield",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Class & subclass features",
      name: "Parry",
      requirement: "Battle Master maneuver",
      resource: "One reaction and one superiority die",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      requirement: "Monk 3",
      resource: "One reaction; 1 ki to throw a caught missile",
      source: "Player's Handbook",
    ...
    {
      id: "ranger-stand-against-the-tide",
      group: "Class & subclass features",
      name: "Stand Against the Tide",
      requirement: "Hunter Ranger 15",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Class & subclass features",
      name: "Uncanny Dodge",
      requirement: "Rogue 5 or Hunter Ranger 15",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Class & subclass features",
      name: "Spell Thief",
      requirement: "Arcane Trickster Rogue 17",
      resource: "One reaction; once per long rest",
      source: "Player's Handbook",
    ...
    {
      id: "sorcerer-bend-luck",
      group: "Class & subclass features",
      name: "Bend Luck",
      requirement: "Wild Magic Sorcerer 6",
      resource: "One reaction and 2 sorcery points",
      source: "Player's Handbook",
    ...
    {
      id: "warlock-misty-escape",
      group: "Class & subclass features",
      name: "Misty Escape",
      requirement: "Archfey Warlock 6",
      resource: "One reaction; once per short or long rest",
      source: "Player's Handbook",
    ...
    {
      id: "warlock-beguiling-defenses",
      group: "Class & subclass features",
      name: "Beguiling Defenses",
      requirement: "Archfey Warlock 10",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Class & subclass features",
      name: "Entropic Ward",
      requirement: "Great Old One Warlock 6",
      resource: "One reaction; once per short or long rest",
      source: "Player's Handbook",
    ...
    {
      id: "wizard-projected-ward",
      group: "Class & subclass features",
      name: "Projected Ward",
      requirement: "Abjuration Wizard 6 with an active Arcane Ward",
      resource: "One reaction and Arcane Ward hit points",
      source: "Player's Handbook",
    ...
    {
      id: "wizard-instinctive-charm",
      group: "Class & subclass features",
      name: "Instinctive Charm",
      requirement: "Enchantment Wizard 6",
      resource: "One reaction; a successful save prevents repeat use on that attacker until a long rest",
      source: "Player's Handbook",
    ...
    {
      id: "wizard-illusory-self",
      group: "Class & subclass features",
      name: "Illusory Self",
      requirement: "Illusion Wizard 10",
      resource: "One reaction; once per short or long rest",
      source: "Player's Handbook",
      trigger: "A creature makes an attack roll against you.",
    ...
    },
    {
      ...
      requirement: "Defensive Duelist feat and a proficient finesse weapon",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Feats",
      name: "Polearm Master Opportunity Attack",
      requirement: "Polearm Master feat and an eligible polearm",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    },
    {
      id: "feat-sentinel",
      group: "Feats",
      name: "Sentinel Retaliation",
      requirement: "Sentinel feat",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      requirement: "Shield Master feat and a shield",
      resource: "One reaction",
      source: "Player's Handbook",
    ...
    },
    {
      id: "feat-war-caster",
      group: "Feats",
      name: "War Caster Opportunity Spell",
      requirement: "War Caster feat",
      resource: "One reaction and any spell cost",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Spells",
      name: "Counterspell",
      requirement: "Counterspell known or prepared",
      resource: "One reaction and a spell slot",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Spells",
      name: "Feather Fall",
      requirement: "Feather Fall known or prepared",
      resource: "One reaction and a spell slot",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Spells",
      name: "Hellish Rebuke",
      requirement: "Hellish Rebuke known or available",
      resource: "One reaction and a spell slot or feature use",
      source: "Player's Handbook",
    ...
    },
    {
      ...
      group: "Spells",
      name: "Shield",
      requirement: "Shield known or prepared",
      resource: "One reaction and a spell slot",
      source: "Player's Handbook",
    ...
    {
      id: "humblewood-glide",
      group: "Humblewood features",
      name: "Glide",
      requirement: "Birdfolk Glide trait",
      resource: "One reaction",
    ...
    {
      id: "humblewood-bind-the-wound",
      group: "Humblewood features",
      name: "Bind the Wound",
      requirement: "College of the Road Bard 3; Traveler\u2019s Trick",
      resource: "One reaction and one Bardic Inspiration die",
      source: "Humblewood Campaign Setting",
    ...
    {
      id: "humblewood-ward-of-shadows",
      group: "Humblewood features",
      name: "Ward of Shadows",
      requirement: "Night Domain Cleric 1",
      resource: "One reaction; uses equal to Wisdom modifier per long rest",
      source: "Humblewood Campaign Setting",
      trigger: "A creature you can see within 30 feet attacks you.",
      effect: "Impose disadvantage on the attack roll. Creatures that cannot be blinded are unaffected.",
    ...
    {
      id: "humblewood-bandit-cunning",
      group: "Humblewood features",
      name: "Bandit Cunning",
      requirement: "Bandit Cunning feat",
      resource: "One reaction; once per long rest",
      source: "Humblewood Campaign Setting",
    ...
    {
      id: "humblewood-feathered-reach",
      group: "Spells",
      name: "Feathered Reach Glide",
      requirement: "Feathered Reach active",
      resource: "One reaction",
      source: "Humblewood Campaign Setting",
    ...
    {
      id: "humblewood-invoke-amaranthine",
      group: "Spells",
      name: "Invoke the Amaranthine",
      requirement: "Invoke the Amaranthine active with a matching recorded die",
      resource: "One reaction and one recorded die",
      source: "Humblewood Campaign Setting",
    ...
    {
      id: "humblewood-spiny-shield",
      group: "Spells",
      name: "Spiny Shield",
      requirement: "Spiny Shield known or prepared",
      resource: "One reaction and a spell slot",
      source: "Humblewood Campaign Setting",
  ...
  function renderReactionPresetOptions() {
    ...
    const suggested = REACTION_PRESETS.filter((preset) => preset.alwaysSuggested || (preset.suggestedTags || []).some((tag) => searchText.includes(tag)));
    if (suggested.length) {
      const group = document.createElement("optgroup");
  ...
  function populateReactionForm(value = {}) {
    ...
    editingReactions.forEach((value) => {
      ...
      <div class="reaction-list-title">
        ...
        <span class="reaction-list-actions">
          ...
          <button type="button" class="del" title="Remove reaction" aria-label="Remove ${escapeHtml(value.name)}">\xD7</button>
        </span>
      </div>
